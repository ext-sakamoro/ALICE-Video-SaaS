...
async fn main() {
    ...
    let state = Arc::new(AppState {
        core_url: env("CORE_ENGINE_URL", "http://core-engine:8115"),
    ...
    tracing::info!("API Gateway (Video) on {addr}");
...
async fn license_handler() -> (HeaderMap, Json<LicenseInfo>) {
    ...
    (h, Json(LicenseInfo {
        ...
        source_code: "https://github.com/ext-sakamoro/ALICE-Video-SaaS".into(),
